...
static VkPipelineStageFlags vk_render_pass_barrier_vrs(VkImageView view, const struct d3d12_resource *resource,
        ...
        enum vkd3d_render_pass_transition_mode mode)
{
    ...
    if (list->vrs_image)
    {
        stage_mask |= vk_render_pass_barrier_vrs(list->vrs_image->vrs_view,
                list->vrs_image, mode, &vk_image_barriers[j++]);
    }
